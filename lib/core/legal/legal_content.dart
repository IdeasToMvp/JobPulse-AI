...
const _contactEmail = 'jaswindersingh@iitdalumni.com';
const _appName = 'JobPulseAI';

const privacyPolicy = LegalDocument(
  title: 'Privacy Policy',
  lastUpdated: 'June 8, 2026',
  summary:
      '$_appName helps you track job applications by syncing job-related emails '
      'from your Gmail account. This policy explains what we collect, how we use '
  ...
  sections: [
    LegalSection(
      ...
      title: 'Who we are',
      paragraphs: [
        '$_appName ("we", "us", or "our") is a job application tracking service available on Android and the web.',
        'If you have questions about this policy, contact us at $_contactEmail.',
      ],
    ),
    LegalSection(
      id: 'what-we-collect',
    ...
    LegalSection(
      ...
      paragraphs: [
        '$_appName is not intended for users under 16. We do not knowingly collect personal information from children.',
      ],
    ),
    LegalSection(
      id: 'changes',
    ...
    LegalSection(
      id: 'contact',
      title: 'Contact',
      paragraphs: ['For privacy questions or requests, email $_contactEmail.'],
    ),
  ],
);
...
const termsOfService = LegalDocument(
  ...
  lastUpdated: 'June 8, 2026',
  summary:
      'These Terms govern your use of $_appName on Android and the web. '
  ...
  sections: [
    LegalSection(
      ...
      paragraphs: [
        'By accessing or using $_appName, you agree to these Terms of Service and our Privacy Policy.',
    ...
    LegalSection(
      ...
      title: 'The service',
      paragraphs: [
        '$_appName provides tools to sync job-related Gmail messages and organize them into an application tracking workflow.',
    ...
    LegalSection(
      ...
      paragraphs: [
        ...
        '$_appName is an organizational tool and does not provide legal, career, or employment advice.',
      ],
    ),
    LegalSection(
      id: 'liability',
      ...
      paragraphs: [
        ...
        'Our total liability for any claim related to the service is limited to the greater of the amount you paid us in the twelve months before the claim or one hundred US dollars.',
      ],
    ),
    LegalSection(
      id: 'termination',
    ...
    LegalSection(
      id: 'contact-terms',
      title: 'Contact',
      paragraphs: ['Questions about these Terms can be sent to $_contactEmail.'],
    ),
  ],
);
