...
class AppColors {
  ...
  static const tertiary = Color(0xFF6C2A00);
  static const neutral = Color(0xFF77767E);
  // Not on palette card — keep only if you still use them (splash, etc.)
  static const backgroundDark = Color(0xFF0D0D2B);
  static const backgroundLight = Color(0xFFF7F7FC);
  ...
  static const splashGradientTop = Color(0xFF1A1A40);
  static const splashGradientBottom = Color(0xFF0D0D2B);
  static const splashBorder = Color(0xFF6B5CE7);
  static const splashProgress = Color(0xFF8B5CF6);
